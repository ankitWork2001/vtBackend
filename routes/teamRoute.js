...
router.post('/team-members',verifyToken,authorizeRoles('admin'),upload.single('image'),teamController.createTeamMember);

// GET specific member
router.get('/team-members/:id',verifyToken,authorizeRoles('admin'), teamController.getTeamMemberById);

// PUT update
router.put('/team-members/:id',verifyToken,authorizeRoles('admin'),upload.single('image'),teamController.updateTeamMember);
